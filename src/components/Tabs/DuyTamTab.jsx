...
• Không phản ánh đúng bản chất của thế giới`;
  ...
  return (
    <div className="animate-fadeIn bg-gradient-to-br from-purple-50 via-pink-50 to-indigo-50 min-h-screen p-4">
      ...
      <div className="mb-8 bg-gradient-to-br from-indigo-50 to-purple-100 rounded-3xl p-8 shadow-xl border border-indigo-200">
        <h4 className="text-2xl font-bold text-indigo-700 mb-6 flex items-center gap-3">
          <BookOpen className="w-7 h-7" />
          Các nhà triết học tiêu biểu và ví dụ
        </h4>

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="bg-white/90 rounded-2xl p-6 shadow-md hover:shadow-xl transition-all hover:-translate-y-2 group">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-14 h-14 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                <Sun className="w-8 h-8 text-white" />
              </div>
              <div>
                <h5 className="font-bold text-gray-800 text-lg">Platon</h5>
                <p className="text-sm text-gray-600">Thuyết Ý niệm</p>
              </div>
            </div>

            <div className="mb-4 p-3 bg-yellow-50 rounded-xl border-l-4 border-yellow-400">
              <p className="text-sm text-gray-700 font-medium mb-2">
                💡 Thế giới ý niệm:
              </p>
              <p className="text-xs text-gray-600 leading-relaxed">
                "Khi nhìn thấy một cái bàn gỗ, bàn sắt hay bàn nhựa, đó chỉ là
                bản sao không hoàn hảo của 'ý niệm Cái Bàn' tồn tại ở thế giới ý
                niệm hoàn hảo."
              </p>
            </div>
          ...
          <div className="bg-white/90 rounded-2xl p-6 shadow-md hover:shadow-xl transition-all hover:-translate-y-2 group">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-14 h-14 bg-gradient-to-br from-blue-400 to-indigo-600 rounded-full flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                <Moon className="w-8 h-8 text-white" />
              </div>
              <div>
                <h5 className="font-bold text-gray-800 text-lg">Berkeley</h5>
            ...
            <div className="mb-4 p-3 bg-blue-50 rounded-xl border-l-4 border-blue-400">
              <p className="text-sm text-gray-700 font-medium mb-2">
                👁️ "Tồn tại là được tri giác":
              </p>
              <p className="text-xs text-gray-600 leading-relaxed">
                "Một cái cây trong rừng nếu không ai nhìn thấy thì vẫn tồn tại
                vì Thượng đế luôn tri giác nó. Không có vật chất độc lập với ý
                thức."
              </p>
            </div>
          ...
          <div className="bg-white/90 rounded-2xl p-6 shadow-md hover:shadow-xl transition-all hover:-translate-y-2 group">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-14 h-14 bg-gradient-to-br from-red-400 to-pink-600 rounded-full flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                <Heart className="w-8 h-8 text-white" />
              </div>
              <div>
                <h5 className="font-bold text-gray-800 text-lg">Hegel</h5>
                <p className="text-sm text-gray-600">Ý niệm tuyệt đối</p>
              </div>
            </div>

            <div className="mb-4 p-3 bg-red-50 rounded-xl border-l-4 border-red-400">
              <p className="text-sm text-gray-700 font-medium mb-2">
                🌍 Tinh thần thế giới:
              </p>
              <p className="text-xs text-gray-600 leading-relaxed">
                "Các cuộc cách mạng, sự phát triển khoa học và văn hóa chỉ là
                biểu hiện của quá trình Ý niệm tuyệt đối tự bộc lộ trong lịch
                sử."
              </p>
            </div>
